...
public class ConversationService {
    ...
    public Mono<Result> getProxiedResponse(String url, Map<String, String> headers, String requestId, Long timeout) {
                ...
                .flatMap(hasElement -> {
                    if (hasElement) {
                        ...
                        return Mono.empty()
                                ...
                                .flatMap(proxy -> getWebClientResponse(url, headers));
                    }
                });
    }
